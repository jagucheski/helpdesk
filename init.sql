...
insert into USUARIO values ('ti.parobe@parobe.rs.gov.br','TI Parobé','$2a$10$Tf/PkBfiWUjjvpiKVRB2Ne56Krj/VbHEx0q.rWKfPPgbFrooaZoqm','35438600','247',FALSE);
...
insert into USUARIO_ROLE values ('ti.parobe@parobe.rs.gov.br','ROLE_ADMIN');
insert into USUARIO_ROLE values ('ti.parobe@parobe.rs.gov.br','ROLE_SUP');
insert into USUARIO_ROLE values ('ti.parobe@parobe.rs.gov.br','ROLE_USER');
...
insert into sub_categoria values (nextval('sub_categoria_id_seq'::regclass),'Domínio',true);
insert into sub_categoria values (nextval('sub_categoria_id_seq'::regclass),'E-mail',true);
