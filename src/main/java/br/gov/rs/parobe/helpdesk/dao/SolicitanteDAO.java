...
public class SolicitanteDAO{
	...
	public List<String> searchSolicitanteAutocomplete(String nome) {
		return manager.createQuery("select CONCAT (u.nome,'-', u.email) from Usuario u where lower(u.nome) LIKE :nome")
