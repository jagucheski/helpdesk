...
<body class="text-center"  style="background-color: #f5f5f5;">
	...
	<main role="main" style="background-color: #f5f5f5;padding: 1rem; min-height: 800px; ">
		<div class="container wrapper" style="margin-top: 100px;">
			<h2 class="display-4"><i class="fas fa-bug fa-xs"></i>  Ops... Erro 500</h2>
			 <br/>
			<p>- Erro interno do servidor -<br/>
			   Desculpe, ocorreu um erro em nosso servidor.<br/>
			   Tente novamente.</p>	
			   <br/>
			   <a style="color:#212529;font-size: 1.5rem;" href="<c:url value='/home'/>" ><i class="fas fa-house-user"></i> HelpDesk</a>						
		</div>
	</main>
