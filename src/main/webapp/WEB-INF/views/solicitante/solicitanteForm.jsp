							...
							<div class="row"> 
								<div class="form-group col"> 
									...
									<div class="input-group" id="show_hide_password">
				 					...
				 					<small id="passwordHelpBlock" class="form-text text-muted" style="margin-left: 15px;">
									  A senha deve ter no mínimo 6 caracteres, pode conter letras e números.
									</small>
								</div>
							</div>
			...
			<form:form id="solicitanteExcluirForm" name="solicitanteExcluirForm" method="POST">
				<div class="modal-content">
					...
					<div class="modal-body"> 
						...
						<div id="alertaExcluirSolicitante"></div> 		
					</div>
					<div class="modal-footer" style="background-color: #e9ecef;">
	      ...
	      success : function(res) {
	         ...
	         if(res.validated){
	            ...
	            msg('#resposta','sucesso', res.message);           
	               ...
	               msg('#alertaExcluirSolicitante','erro', msg_err);   
	         }
	      }
	   })
	});
