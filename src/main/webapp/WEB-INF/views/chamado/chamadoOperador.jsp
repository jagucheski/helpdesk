		...
		<div class="container wrapper" >
			<form:form action="${s:mvcUrl('COC#pesquisar').build() }" id="chamadoFindForm" method="POST">
				...
				<div style="margin-left:10px">
					...
					<div class="form-group row">
				    	<label class="col-sm-1 col-form-label col-form-label-sm">Solicitante:</label>
					  	<div class="col-md-6" style="margin-left: -20px;">
							<input type="text" id="solicitanteFind" name="solicitanteFind" maxlength="60"
					       	class="form-control form-control-sm" autofocus>
						</div>	
				    	<label class="col-sm-1 col-form-label col-form-label-sm">Status:</label>
				    	<div class="form-group col-md-6" style="max-width: 300px;margin-left: -20px;">
